...
public enum Monster {
    ...
    EYE_EATING_CROW("Eye-Eating Crow", "A crow who lives around cemeterys, attacking the grieving when there is no corpse to eat.", 35, 0, 85, 0, 7),
    ...
    BLACK_DRAGON("Black Dragon", "A dragon who has been ousted by its family when it was young. It survived, only motiviated by its anger.", 150, 0, 70, 20, 40),
    ...
    QUEJUKU("Quejuku", "A creature so strange no one ever manged to describe it accurately on paper. The accounts differ so much that many scholars belief that it changes certains aspect of its body regarding to what their opponent fears the most.", 999, 0, 100, 100, 100),
    ...
    LITTLE_EYE("Little Eye", "An still functioncal eye of a watcher which was shed voluntarily in order to observe their domain.", 25, 0, 100, 0, 6),
    ...
    BROWN_ALPHA_WOLF("Brown Alpha Wolf", "The leader of a pack of brown wolves. Can hold their own against larger wolf species.", 70, 0, 100, 6, 20),
    SMALLTIME_POACHER("Smalltime Poacher", "A hunter without a license or ethics. Doesn't take it lightly when someones marches into their hunting grounds.", 55, 0, 100, 5, 20),
    ...
    ROTTING_UNDEAD("Rotting Undead", "A zombie who has been (not) alive for over a century.", 35, 0, 100, 0, 12),
    SKELETON_WARRIOR("Skeleton Warrior", "The remains of a fallen warrior whose desire for blood hasn't even been quenched by their demise.", 45, 0, 80, 5, 25),
    ...
    YELLOW_SKINNED_SCORPION("Yellow-Skinned Scorpion", "A subspecies of the White-Eyed Scorpion. A nocturnal threat found in most deserts.", 40, 0, 85, 5, 18),
    SAND_GOLEM("Sand Golem", "A giant humanoid made out of sand. Its hard to land a solid attack.", 80, 0, 60, 15, 20),
    SADWONMOR("Sadwonmor", "A gigantic worm slithering on and under the giant dunes of the desert, devouring evertyhing along its way.", 300, 0, 100, 50, 80),
    ...
    TROPICAL_POACHER("Tropical Poacher", "A poacher who specialises killing mammals of the jungle.", 60, 0, 100, 5, 20),
    ...
    MUJULIN("Mijulin", "A giant lizard like being made out of the vegetation of its territority. Feasts on the fruits that grows on it own body.", 230, 0, 100, 50, 70),
    ...
    CRYING_SIREN("Crying Siren", "A sea creature who shapeshifts into the most loved person of it's prey to lure them in.", 40, 0, 100, 10, 20),

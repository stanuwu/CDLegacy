...
public enum Monster {
    ...
    HUNGRY_GHOUL("Hungry Ghoul", "An dwarfish creature with long limbs rotting, poisonous teeth.", 25, 0, 100, 0, 8),
    ...
    WHITE_EYED_SCORPION("White-Eyed Scorpion", "A scorpion who is roughly the size of a pig. Lives in caves because the sunlight hurts its eyes.", 40, 0, 85, 5, 18),
    ...
    BUZZING_DRAGONFLY("Buzzing Dragonfly", "Bigger and more aggressive than normal dragonflies. Easy to kill, but their bites can cause grave wounds.", 20, 0, 100, 0, 30),
